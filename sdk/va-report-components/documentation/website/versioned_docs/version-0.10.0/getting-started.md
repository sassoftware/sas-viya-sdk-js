---
id: version-0.10.0-getting-started
...
as <a target="_blank" href="https://unpkg.com/">UNPKG</a> and <a target="_blank" href="https://www.jsdelivr.com/">jsDelivr</a>. Here is an example of loading the 0.10.0 version of `va-report-components` from UNPKG
...
```html
<script async src="https://unpkg.com/@sassoftware/va-report-components@0.10.0/dist/umd/va-report-components.js"></script>
```
